...
const CorporateCommunicationList = () => {
  const { isDarkMode, corporateCommunicationData, myProfileDetails } = useSelector(stateSelector);
  ...
  const handleOnClickItem = (item) => {
    ...
    navigation.navigate(NavigationRouteNames.CORPORATECOMMUNICATIONDETAILS as never, {
      id: item?.id
    });
  };
    ...
    if (corporateCommunicationData === undefined) {
      ...
      return (
        <View style={styles.listView}>
          <FlatList
            data={corporateCommunicationData}
    ...
    <WrapperContainer>
      <SafeAreaView
        ...
        <HeaderSVG
          ...
          titleText={localize('home.corporateCommunication')}
          titleFont={20}
        />
...
export default CorporateCommunicationList;

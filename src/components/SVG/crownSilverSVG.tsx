...
const CrownSilverSVG = (props) => (
  <Svg
    ...
    <Path
      ...
      fill="url(#paint0_linear_2293_28610)"
    />
    <Defs>
      <LinearGradient
        id="paint0_linear_2293_28610"
        x1={2.54929}
        y1={8.94819}
        x2={10.6591}
        y2={4.87501}
        ...
        <Stop offset={1} stopColor="#EBECEE" />
      </LinearGradient>
    </Defs>
  </Svg>
);

CrownSilverSVG.propTypes = {
  isDarkMode: PropTypes.bool
};

CrownSilverSVG.defaultProps = {
  isDarkMode: false
};

export default CrownSilverSVG;

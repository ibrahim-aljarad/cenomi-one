import { ANNYVERSARY_WISH_MSG, LOTTIE_JSON_FILES } from '../../utils/constants';
...
const OthersAnniversary = ({ modalInfo, isDarkMode }) => {
  ...
  const sendMail = (email) => {
    const subject = 'Anniversary Wish';
    const body = ANNYVERSARY_WISH_MSG;
      ...
      <>
        <View
          ...
          <CustomText
            ...
            {localize('wish.wishYourColleagueAnniversary')}
          </CustomText>
...
export default OthersAnniversary;

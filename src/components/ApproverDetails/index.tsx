...
import { getColorWithOpacity, getDateFormat, RfH, RfW } from '../../utils/helper';
import IconButtonWrapper from '../IconButtonWrapper';

const ApproverDetails = ({ taskItem, details }) => {
      ...
      <View style={styles.headerContainer}>
            ...
            <View style={styles.nameDesignationContainer}>
              ...
              <View
                style={[
                  styles.statusBadge,
                  {
                    backgroundColor: taskItem.isCompleted ? '#e8f5e9' : '#fff3e0',
                  }
                ]}
              >
                <Text
        ...
        {hasComments && (
          <IconButtonWrapper
            ...
            iconImage={isExpanded ? Images.arrowDownBlack : Images.arrowRightblack}

...
export const EVENT_NAME = {
  ...
  PRESSED_KNOWLEDGE_HUB_SEEALL_FROM_HOME:
    "pressed_knowledge_hub_seeall_from_home",
  ...
  PRESSED_MANAGE_BIOMETRIC_FROM_PROFILE:
    "pressed_manage_biometric_from_profile",
  PRESSED_APPS_SETTINGS_FROM_PROFILE: "pressed_apps_settings_from_profile",
  PRESSED_NOTIFICATION_SETTINGS_FROM_PROFILE:
    "pressed_notification_settings_from_profile",
  ...
  PRESSED_METER_READINGS: "pressed_meter_readings",
